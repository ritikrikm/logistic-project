        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* {isLoaded && (
            <>
              ...
              <Autocomplete
                onLoad={(auto) => setDeliveryAuto(auto)}
          ...
          <textarea name="notes" value={form.notes} onChange={handleChange} placeholder="Additional Notes" className="border p-2 rounded col-span-1 sm:col-span-2" rows={3} />

          <button
            type="submit"
            className="col-span-1 sm:col-span-2 w-full py-2 rounded text-white font-semibold bg-primary hover:bg-primary-dark"
          >
